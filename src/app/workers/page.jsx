  ...
  return (
    <div className="w-full mx-auto mt-[20px] flex flex-col ">
      ...
      <Link href='/'><ArrowLeft fontWeight='bold' size={33} className="text-white bg-[#e59c71] font-bold p-1 rounded-full md:scale-200 cursor-pointer" /></Link>
        <p className="text-[#e59c71] text-lg md:text-2xl font-bold flex flex-col md:flex-row items-center gap-3">Available Experts: <span className="text-[#e59c71]">({maidsCount})</span></p>
        <Dialog className="flex-end">
          <DialogTrigger>
            <Button className="flex items-center gap-3 bg-[#e59c71] hover:bg-secondary">Filter <FilterIcon className='hidden md:block'/></Button>
          </DialogTrigger>
      ...
      :
            <div className="flex flex-wrap items-center justify-center gap-x-2 md:gap-x-8 gap-y-20 pt-[25%] md:pt-[15%] z-0 pb-10">
